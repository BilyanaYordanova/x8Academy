...
class AllFailingStudentsTest {

	AllFailingStudents object = new AllFailingStudents();
	...
	void fillList() {
		...
		failingStudents = object.getAllFailingStudents(students);
	}

	@Test
	void test1() {
		fillList();
		assertTrue(failingStudents.contains(AntonIliev));
	}

	@Test
	void test2() {
		fillList();
		assertTrue(failingStudents.contains(IvaIvanova));
	}

	@Test
	void test3() {
		fillList();
		assertFalse(failingStudents.contains(GeorgiPopov));
	}
}
